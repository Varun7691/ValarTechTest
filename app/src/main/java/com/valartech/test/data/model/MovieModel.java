...
public class MovieModel implements Parcelable {
    ...
    private List<RatingsModel> mRatings;
    ...
    public void setRatings(List<RatingsModel> ratings) {
        mRatings = ratings;
    }
